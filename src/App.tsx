    ...
    <div className="p-5 min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="max-w-4xl mx-auto">
        <header className="app-header mb-8">
          ...
          {/* Dynamic environment notice */}
          {isStaging ? (
            <div className="environment-notice mb-8 p-4 bg-blue-50 border-l-4 border-blue-400 rounded-r-md">
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-blue-700">
                    <strong>Staging Environment:</strong> Connected to LaunchDarkly staging (ld-stg.launchdarkly.com). 
